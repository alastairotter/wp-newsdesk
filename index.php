...
<div class="nd-plugin-title">
    ...
    <?php 
    // echo "<img src='" . plugin_dir_url( __FILE__ ) . "assets/images/newsdesk.svg'>";
    ?>
</div>
<!-- A set of tools for managing a publishing workflow.<br/><br/> -->
...
// $row .= "<th class='manage-column column-title column-primary'>Type</th>";
// $row .= "<th class='manage-column column-title column-primary'>Author</th>";
// $row .= "<th class='manage-column column-title column-primary'>Type</th>";
// $row .= "<th class='manage-column column-title column-primary'>Published</th>";
$row .= "</tr></thead>";
...
<!-- 
<table class="wp-list-table widefat fixed striped table-view-list posts" style="width: 90%;">
    <thead>
        <tr>
            <td scope="col" id="title" class="manage-column column-title">Title</td>
        </tr>
    </thead>
</table> -->
